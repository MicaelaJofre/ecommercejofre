        ...
        <>
            <div className='containerBanner'>
                <div className="cardBanner line">
                    <img src={process.env.PUBLIC_URL + '/assets/image/creditCards.png'} alt="tarjetas de crédito y débito" />
                ...
                <div className="cardBanner line">
                    <img src={process.env.PUBLIC_URL + '/assets/image/enviado.png'} alt="envío rápido" />
                ...
                <div className="cardBanner">
                    <img src={process.env.PUBLIC_URL + '/assets/image/proteger.png'} alt="compra protegida" />
